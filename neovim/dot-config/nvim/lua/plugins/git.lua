      ...
      return {
        ...
        keymaps = {
          ...
          diff3 = {
            ...
            { { 'n', 'x' }, '<localleader>2', actions.diffget 'ours', { desc = 'Obtain the diff hunk from the OURS version of the file' } },
            { { 'n', 'x' }, '<localleader>3', actions.diffget 'theirs', { desc = 'Obtain the diff hunk from the THEIRS version of the file' } },
          },
          diff4 = {
            -- Mappings in 4-way diff layouts
            { { 'n', 'x' }, '<localleader>1', actions.diffget 'base', { desc = 'Obtain the diff hunk from the BASE version of the file' } },
            { { 'n', 'x' }, '<localleader>2', actions.diffget 'ours', { desc = 'Obtain the diff hunk from the OURS version of the file' } },
            { { 'n', 'x' }, '<localleader>3', actions.diffget 'theirs', { desc = 'Obtain the diff hunk from the THEIRS version of the file' } },
          },
          file_panel = {
